...
SWIFT_CLASS("_TtC13SAPFoundation22DefaultSAPWKUIDelegate")
...
///
/// \endcodeFrom now on, when the system calls on of the WKUIDelegate methods, the proxy will be called.
