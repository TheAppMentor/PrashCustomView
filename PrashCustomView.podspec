#
# Be sure to run `pod lib lint PrashCustomView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'PrashCustomView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PrashCustomView.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'PrashCustomView' => ['PrashCustomView/Assets/*.png']
  # }
